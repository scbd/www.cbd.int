define(['app', 'jquery', 'lodash', 'text!./redirect-dialog.html','providers/extended-route', 'ngRoute', 'authentication', 'ngDialog','ngCookies'], function(app, $, _,redirectDialog) {
  ...
  function registerRoutes_CopDecisions(routeProvider) {
      ...
      routeProvider.when('/',                                    { templateUrl: 'views/redirect.html',            resolveController: true })
      ...
      routeProvider.when('/:body',                               { templateUrl: 'views/redirect.html',            resolveController: true} )
    ...
    function registerRoutes_meetings(routeProvider) {
        ...
        .when('/:meeting/sessions/:sessionId',{ templateUrl : 'views/meetings/documents/statements/session-prep.html', resolveController : true,  reloadOnSearch:false, resolve : { user : securize(["Administrator","EditorialService", "StatementAdmin", "ScbdStaff", "Interpreters"]) } })
...
//criteria-procedure
    ...
    function registerRoutes_participation(routeProvider) {
        ...
        .when('/:conference/media'                  ,{ templateUrl: 'views/media-requests/detect.html',              resolveController : true,   resolve : { user : currentUser(), routeParams: injectRouteParams({ type: 'media' })  } } ) // Force media
