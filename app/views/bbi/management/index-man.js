define(['app', 'lodash','data/bbi/links-platform','text-loader!directives/bbi/forms/bbi-records-dialog.html','text-loader!./first-dash-dialog.html','services/user-settings', 'directives/bbi/menu',"util/solr", 'providers/realm','directives/bbi/auto-linker','ngDialog'], function(app, _,links,recordsDialog,dashDialog) { 'use strict';
