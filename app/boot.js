...
export default function bootApp(window, require, defineX) {
  ...
  require.config({
      ...
      paths: {
          ...
          'angular-vue'       : `${cdnUrl}npm/@scbd/angular-vue@4.0.0/dist/index.min`,
      ...
      shim: {
          ...
          'facebook'             : { exports: 'FB'},
          'conferenceCal'        : { deps : ['angular-vue', `css!${cdnUrl}npm/@scbd/conference-cal@0.1.2/dist/lib/ConferenceCal.css`] },
          'angular-cache'        : { deps : ['angular'] },
          'PageHeaderFixed'      : { deps : ['angular-vue'] },
          'PageFooter'           : { deps : ['angular-vue'] },
          'PageHeader'           : { deps : ['angular-vue'] },
