...
const decisionDashboard   = { component: ()=>import('~/views/decisions/dashboard.vue').catch(logError) }
...
app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    ...
    .when('/dashboard',                           { ...mapView(vueViewWrapper),         resolve: { ...decisionDashboard, user : currentUser() } } )
