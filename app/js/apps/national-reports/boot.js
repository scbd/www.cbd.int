...
require.config({
    ...
    paths: {
        ...
        'ngRoute'         : cdnHost + 'angular-route@1.7.4/angular-route.min',
        'ngCookies'       : cdnHost + 'angular-cookies@1.7.4/angular-cookies.min',
        'ngAnimate'       : cdnHost + 'angular-animate@1.7.4/angular-animate.min',
        'ngSanitize'      : cdnHost + 'angular-sanitize@1.7.4/angular-sanitize.min',
