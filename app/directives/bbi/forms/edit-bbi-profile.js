define(['text-loader!./edit-bbi-profile.html', 'text-loader!./bbi-records-dialog.html', 'text-loader!./first-provider-dialog.html', 'app', 'angular', 'lodash', 'authentication',
							...
							function(success) {
								...
								if ($scope.validationReport.errors && Array.isArray($scope.validationReport.errors) && $scope.validationReport.errors.length) {
									...
									_.each(frontEndValidationReport.errors, function(err) {
										if (!_.find($scope.validationReport.errors, {
