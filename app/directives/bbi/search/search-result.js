define(['text-loader!./search-result.html', 'app', 'lodash', 'moment', 'lodash', 'authentication','providers/realm','filters/term',    'filters/moment'], function(template, app, _, moment, authentication) {
    'use strict';
