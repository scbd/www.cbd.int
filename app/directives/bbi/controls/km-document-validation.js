define(['app', 'text-loader!./km-document-validation.html','jquery'], function(app, template,$) { 'use strict';
        ...
        return {
            ...
            link: function($scope, $element, $attr) {
                ...
                $scope.jumpTo = function(field) {
                    ...
                    var qLabel = $element.parents("[km-tab]:last").parent().parent().find("form[name='editForm'] label[for='" + field + "']:first");
