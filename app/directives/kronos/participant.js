    ...
    console.log($scope.binding.attachment)
        ...
        function save(){
          ...
          if(!$scope.binding._id)
            return $http.post('http://localhost:2000/api/v2018/kronos/participation/request/participants',$scope.binding,{headers:{requestId:$scope.requestId,conferenceCode:$scope.conferenceCode}})
                .then(function(res){
            ...
            return $http.put('http://localhost:2000/api/v2018/kronos/participation/request/participants/'+encodeURIComponent($scope.binding._id),$scope.binding,{headers:{requestId:$scope.requestId,conferenceCode:$scope.conferenceCode}})
                .then(function(res){
                  $scope.showContact=false;
                })
                .catch(function(err){
